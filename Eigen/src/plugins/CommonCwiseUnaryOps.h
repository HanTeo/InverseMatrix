...
///
EIGEN_DOC_UNARY_ADDONS(cast, conversion
function)
///
...
///
EIGEN_DOC_UNARY_ADDONS(conjugate, complex
conjugate)
///
...
///
EIGEN_DOC_UNARY_ADDONS(real, real
part function
)
///
/// \sa imag()
...
///
EIGEN_DOC_UNARY_ADDONS(imag, imaginary
part function
)
///
/// \sa real()
...
///
EIGEN_DOC_UNARY_ADDONS(unaryExpr, unary
function)
///
...
/// Output: \verbinclude class_CwiseUnaryOp.out
///
EIGEN_DOC_UNARY_ADDONS(unaryViewExpr, unary
function)
///
