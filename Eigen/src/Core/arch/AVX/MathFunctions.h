...
// are (anti-)symmetric and thus have only odd/even coefficients
        ...
        psin<Packet8f>(const Packet8f &_x) {
            ...
            Packet8i shift_isodd = _mm256_castps_si256(
                    _mm256_and_ps(_mm256_castsi256_ps(shift_ints), _mm256_castsi256_ps(p8i_one)));
...
//               polynomial interpolants -> ... -> profit!
        ...
        plog<Packet8f>(const Packet8f &_x) {
            ...
            Packet8f invalid_mask = _mm256_cmp_ps(x, _mm256_setzero_ps(),
